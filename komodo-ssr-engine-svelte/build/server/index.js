import { S as SvelteKitError, j as json, t as text, R as Redirect, H as HttpError, e as error, A as ActionFailure } from './chunks/index-CJiV4IBS.js';
import { t as text_decoder, b as base64_decode, d as define_property, o as object_prototype, a as array_prototype, g as get_descriptor, s as safe_equals, i as is_extensible, c as array_from, e as get_prototype_of, f as is_array, h as deferred, r as run_all, j as equals, k as index_of, l as decode_pathname, m as decode_params, p as normalize_path, q as disable_search, u as with_request_store, v as validate_layout_server_exports, x as validate_layout_exports, y as validate_page_server_exports, z as validate_page_exports, A as text_encoder, B as resolve, C as make_trackable, D as get_relative_path, E as base64_encode, w as writable, F as readable } from './chunks/exports-BqZqNlfe.js';
import { D as DevalueError, i as is_primitive, g as get_type, c as is_plain_object, d as enumerable_symbols, s as stringify_key, f as stringify_string, r as render, L as LEGACY_PROPS, C as CONNECTED, E as ERROR_VALUE, j as COMMENT_NODE, H as HYDRATION_START, k as HYDRATION_ERROR, S as STATE_SYMBOL, U as UNINITIALIZED, l as DERIVED, m as DIRTY, M as MAYBE_DIRTY, n as CLEAN, I as INERT, o as EFFECT, B as BLOCK_EFFECT, W as WAS_MARKED, p as BRANCH_EFFECT, R as ROOT_EFFECT, q as RENDER_EFFECT, t as MANAGED_EFFECT, u as DESTROYED, A as ASYNC, v as HEAD_EFFECT, w as REACTION_IS_UPDATING, x as EFFECT_RAN, y as EFFECT_PRESERVED, z as EFFECT_TRANSPARENT, F as BOUNDARY_EFFECT, G as EAGER_EFFECT, J as STALE_REACTION, K as is_passive_event, N as HYDRATION_END, O as HYDRATION_START_ELSE, P as USER_EFFECT, Q as uneval } from './chunks/index2-DTE7gUAU.js';
import { c as setContext } from './chunks/context-D64tQzLr.js';
...
async function get_hooks() {
  ...
  let init;
  ({ handle, handleFetch, handleError, handleValidationError, init } = await import('./chunks/hooks.server-DvsLJlfy.js'));
  let reroute;
  let transport;
  return {
    handle,
