...
func TokenGenerate(req *http.Request, payload *TokenGenerateRequest) *httpApi.APIResponse{
	// TODO implement internal auth service call to get M2M token

	res := &httpApi.APIResponse{
...
func TokenVerify(req *http.Request) *httpApi.APIResponse {
...
func TokenRevoke(req *http.Request) *httpApi.APIResponse {
