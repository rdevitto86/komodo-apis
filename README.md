...
**Misc**  
- **Language/Stack:** Golang (Chi)
- **Port:** DEV: 7001 | PROD: 8080
- **Key Ops:** Bearer tokens, validation
...
**Overview**  
Authentication using JWT/session tokens, MFA, passkeys

**Misc**  
- **Language/Stack:** Golang (Chi)
- **Port:** DEV: 7002 | PROD: 8080
- **Key Ops:** Login, Session Tokens, MFA, Passkeys
- **Docs/Health:** `/docs`, `/health`

### komodo-auth-ouath-api
