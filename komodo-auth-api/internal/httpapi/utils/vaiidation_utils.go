...
func IsValidPathParams(params model.PathParams, req *http.Request) bool {
...
func IsValidQueryParams(params model.QueryParams, req *http.Request) bool {
	if len(params) == 0 { return false }
...
func IsValidBody(body model.Body, req *http.Request) bool {
